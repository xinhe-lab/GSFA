...
`prior_beta_s`, and `prior_beta_r` are prior parameters of the effects of perturbations 
on the factors. For details about the GSFA model and prior specification, 
