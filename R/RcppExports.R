...
gsfa_gibbs_cpp <- function(Y, G, K, prior_type = "mixture_normal", initialize = "svd", prior_s = 50, prior_r = 0.2, prior_sb = 20, prior_rb = 0.2, prior_gp = 1, prior_hp = 1, prior_gb = 1, prior_hb = 1, prior_gw = 1, prior_hw = 1, prior_gc = 3, prior_hc = 0.5, niter = 500L, ave_niter = 200L, lfsr_niter = 200L, verbose = TRUE, return_samples = TRUE) {
    .Call('_GSFA_gsfa_gibbs_cpp', PACKAGE = 'GSFA', Y, G, K, prior_type, initialize, prior_s, prior_r, prior_sb, prior_rb, prior_gp, prior_hp, prior_gb, prior_hb, prior_gw, prior_hw, prior_gc, prior_hc, niter, ave_niter, lfsr_niter, verbose, return_samples)
}
